...
public class Cart {
    ...
    public void addDigitalVideoDisc(DigitalVideoDisc disc) {
        if(qtyOrdered >= MAX_NUMBERS_ORDERED) {
            System.out.println("The cart.Cart is almost full!");
            return;
        }
    ...
    /*public void addDigitalVideoDisc(disc.DigitalVideoDisc[] dvdList) {
        for(disc.DigitalVideoDisc dvd : dvdList) {
            if(qtyOrdered < MAX_NUMBERS_ORDERED) {
    ...
    public List<DigitalVideoDisc> searchByTitle(String title) {
        List<DigitalVideoDisc> matchedDvds = new ArrayList<>();
        for(DigitalVideoDisc dvd : itemsOrdered) {
